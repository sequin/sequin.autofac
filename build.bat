...
"packages\FAKE\tools\Fake.exe" "build.fsx" target=createpackages version=%version% semver=%semver% packageversion=%packageversion% projects=Sequin.Autofac nugetApiKey=%NUGET_API_KEY% %*
